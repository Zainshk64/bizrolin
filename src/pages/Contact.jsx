    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setFormData({
                ...
                company: '', subject: '', message: '', privacyConsent: false
            });
        ...
        const ctx = gsap.context(() => {
            ...
            tl.fromTo('.contact-hero-badge',
                ...
                .fromTo('.contact-hero-title',
                    { opacity: 0, y: 40, visibility: 'visible' },
                    { opacity: 1, y: 0, duration: 1.4 }, '-=0.6'
                )
            ...
            const revealElements = document.querySelectorAll('.revealc-up, .revealc-left, .revealc-right, .revealc-scale');
            ...
            <section className="contact-hero" ref={heroRef}>
                ...
                <div className="contact-hero-container">
                    ...
                    <p className="contact-hero-subtitle revealc-up">
                        Have a question or want to explore partnership opportunities? We'd love to hear from you. Our team is ready to help.
                    </p>
                </div>
            </section>
                ...
                <div className="contact-container">
                    ...
                    <div className="contact-info">
                        <div className="contact-info-header revealc-left">
                            ...
                            <h2 className="contact-info-title">We're Here to Help Your Business Grow</h2>
                            <p className="contact-info-desc">
                                Reach out to us through any of the channels below. Our dedicated team responds within 24 hours.
                            </p>
                        </div>
                    ...
                    <div className="contact-form-container revealc-right">
                        ...
                        <form className="contact-form" onSubmit={handleSubmit}>
                            ...
                            <button type="submit" className="form-submit" disabled={formStatus === 'sending'}>
                                {formStatus === 'sending' ? (
                                    <>Sending... <Loader2 className="animate-spin ml-2" size={20} /></>
                                ) : (
                                    <>Send Message <ArrowRight className="form-submit-icon ml-2" size={20} /></>
                                )}
                            </button>

                            {formStatus === 'success' && (
                                <div className="form-status success">
                                    <span className="form-status-icon"><Check size={20} /></span>
                                    <span className="form-status-text">Message sent successfully! We'll get back to you within 24 hours.</span>
                                </div>
                            )}

                            {formStatus === 'error' && (
                                <div className="form-status error">
                                    <span className="form-status-icon"><X size={20} /></span>
                                    <span className="form-status-text">Failed to send message. Please try again or contact us directly.</span>
                                </div>
                            )}
                        </form>
                    </div>
            ...
            <section className="map-section">
                <div className="map-container">
                    <div className="map-header revealc-up">
                        ...
                        <p className="map-subtitle">Visit us at any of our offices around the world</p>
                    </div>

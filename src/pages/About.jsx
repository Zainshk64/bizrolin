  ...
  const timeline = [
    {
      year: "1995",
      title: "Foundation",
      desc: "Bizrolin Group was founded as a small trading company in Dubai.",
    },
    {
      year: "2002",
    ...
    },
    {
      ...
      desc: "Launched Bizrolin Foods and Bizrolin Entertainment divisions.",
    },
    {
      year: "2023",
      title: "$10B Revenue",
        ...
        <section className="about-hero" data-scroll-section>
          <div className="about-hero-content">
            ...
            <p data-scroll data-scroll-speed="0.5">
              BizRolin is an all-in-one business ecosystem delivering smart,
              scalable solutions through innovation, strategy, and expert
              ventures, helping brands grow faster, operate smarter, and reach
              globally.{" "}
            </p>
          </div>
          <div
        ...
        <section className="values-section" data-scroll-section>
          ...
          <div className="values-grid">
            {values.map((val, index) => (
              <div
                key={index}
                className="value-card hover-trigger"
                data-scroll
